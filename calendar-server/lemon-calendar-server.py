...
gi.require_version('Lemon', '0.1')
from gi.repository import GLib, Gio, GObject
from gi.repository import EDataServer, ECal, ICal, ICalGLib
from gi.repository import Lemon

BUS_NAME = "org.lemon.CalendarServer"
BUS_PATH = "/org/lemon/CalendarServer"
...
class CalendarServer(Gio.Application):
    def __init__(self, hold=False):
        ...
        self.interface = Lemon.CalendarServerSkeleton.new()
...
def main():
    setproctitle("lemon-calendar-server")
