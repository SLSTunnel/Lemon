 ...
 * We should use new api when possible, especially in core lemon js.
 */
...
G_DEFINE_TYPE (LemonScreen, lemon_screen, G_TYPE_OBJECT);

static void
lemon_screen_set_property (GObject      *object,
                          guint         prop_id,
                          const GValue *value,
                          GParamSpec   *pspec)
{
  LemonScreen *screen = LEMON_SCREEN (object);
...
static void
lemon_screen_get_property (GObject      *object,
                          guint         prop_id,
                          GValue       *value,
                          GParamSpec   *pspec)
{
...
static void
lemon_screen_constructed (GObject *object)
{
  G_OBJECT_CLASS (lemon_screen_parent_class)->constructed (object);
  LemonScreen *screen = LEMON_SCREEN (object);
...
static void
lemon_screen_finalize (GObject *object)
{
  /* Actual freeing done in lemon_screen_free() for now */

  G_OBJECT_CLASS (lemon_screen_parent_class)->finalize (object);
}

static void
lemon_screen_class_init (LemonScreenClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);
  GParamSpec   *pspec;

  object_class->get_property = lemon_screen_get_property;
  object_class->set_property = lemon_screen_set_property;
  object_class->constructed = lemon_screen_constructed;
  object_class->finalize = lemon_screen_finalize;
...
static void
lemon_screen_init (LemonScreen *screen)
{
}

LemonScreen *
lemon_screen_new (MetaDisplay *display)
{
    return g_object_new (LEMON_TYPE_SCREEN, "display", display, NULL);
}

/**
 * lemon_screen_get_n_workspaces:
 * @screen: a #LemonScreen
 *
 ...
 */
int
lemon_screen_get_n_workspaces (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 1);
...
/**
 * lemon_screen_get_workspace_by_index:
 * @screen: a #LemonScreen
 ...
 */
MetaWorkspace*
lemon_screen_get_workspace_by_index (LemonScreen  *screen,
                                        int              idx)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), NULL);
 ...
 */
void
lemon_screen_remove_workspace (LemonScreen *screen,
                                  MetaWorkspace  *workspace,
                                  guint32         timestamp)
{
  g_return_if_fail (LEMON_IS_SCREEN (screen));
...
/**
 * lemon_screen_append_new_workspace:
 * @screen: a #LemonScreen
 ...
 */
MetaWorkspace *
lemon_screen_append_new_workspace (LemonScreen *screen,
                                      gboolean        activate,
                                      guint32         timestamp)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), NULL);
...
/**
 * lemon_screen_get_mouse_window:
 * @screen: a lemon-screen.
 ...
 */
MetaWindow*
lemon_screen_get_mouse_window (LemonScreen  *screen,
...
/**
 * lemon_screen_get_monitor_index_for_rect:
 * @screen: a #LemonScreen
 * @rect: the rectangle
 *
 ...
 */
int
lemon_screen_get_monitor_index_for_rect (LemonScreen    *screen,
                                            MetaRectangle *rect)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 0);
...
/**
 * lemon_screen_get_current_monitor:
 * @screen: a #LemonScreen
 *
 ...
 */
int
lemon_screen_get_current_monitor (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 0);
 ...
 */
int
lemon_screen_get_n_monitors (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 1);
...
/**
 * lemon_screen_get_primary_monitor:
 * @screen: a #LemonScreen
 *
 ...
 */
int
lemon_screen_get_primary_monitor (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 0);
...
/**
 * lemon_screen_get_monitor_geometry:
 * @screen: a #LemonScreen
 ...
 */
void
lemon_screen_get_monitor_geometry (LemonScreen    *screen,
                                      int                monitor,
...
/**
 * lemon_screen_override_workspace_layout:
 * @screen: a #LemonScreen
 ...
 */
void
lemon_screen_override_workspace_layout (LemonScreen      *screen,
 ...
 */
void
lemon_screen_toggle_desktop (LemonScreen *screen,
                                guint32         timestamp)
{
 ...
 */
void
lemon_screen_show_desktop (LemonScreen *screen,
                              guint32         timestamp)
{
 ...
 */
MetaDisplay *
lemon_screen_get_display (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), NULL);
 ...
 */
void
lemon_screen_get_size (LemonScreen *screen,
                      int        *width,
                      int        *height)
{
  g_return_if_fail (LEMON_IS_SCREEN (screen));
...
/**
 * lemon_screen_get_workspaces: (skip)
 * @screen: a #LemonScreen
 *
 ...
 */
GList *
lemon_screen_get_workspaces (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), NULL);
...
/**
 * lemon_screen_get_active_workspace_index:
 * @screen: a #LemonScreen
 *
 ...
 */
int
lemon_screen_get_active_workspace_index (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 0);
...
/**
 * lemon_screen_get_active_workspace:
 * @screen: a #LemonScreen
 *
 ...
 */
MetaWorkspace *
lemon_screen_get_active_workspace (LemonScreen *screen)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), NULL);
...
/**
 * lemon_screen_get_monitor_in_fullscreen:
 * @screen: a #LemonScreen
 * @monitor: the monitor number
 *
 ...
 * LemonScreen::in-fullscreen-changed.
 *
 ...
 */
gboolean
lemon_screen_get_monitor_in_fullscreen (LemonScreen  *screen,
                                       int          monitor)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), FALSE);
...
/**
 * lemon_screen_get_xwindow_for_window:
 * @screen: a #LemonScreen
 ...
 */
unsigned long
lemon_screen_get_xwindow_for_window (LemonScreen *screen,
                                        MetaWindow     *window)
{
  g_return_val_if_fail (LEMON_IS_SCREEN (screen), 0);
