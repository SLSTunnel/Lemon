...
/* lemon-perf-helper: a program to create windows for performance tests
 *
...
#define BUS_NAME "org.Lemon.PerfHelper"
...
static const gchar introspection_xml[] =
	  "<node>"
	  "  <interface name='org.Lemon.PerfHelper'>"
	  "    <method name='Exit'/>"
...
main (int argc, char **argv)
{
  ...
  /* Since we depend on this, avoid the possibility of lt-lemon-perf-helper */
  g_set_prgname ("lemon-perf-helper");
