 ...
 *
 * A #LemonStack draws its children on top of each other,
...
#include "lemon-stack.h"

G_DEFINE_TYPE (LemonStack,
               lemon_stack,
               ST_TYPE_WIDGET);

static void
lemon_stack_allocate (ClutterActor           *self,
...
static void
lemon_stack_get_preferred_height (ClutterActor *actor,
                                     gfloat for_width,
                                     gfloat *min_height_p,
...
static void
lemon_stack_get_preferred_width (ClutterActor *actor,
                                 gfloat for_height,
                                 gfloat *min_width_p,
...
static gboolean
lemon_stack_navigate_focus (StWidget         *widget,
                            ClutterActor     *from,
...
static void
lemon_stack_class_init (LemonStackClass *klass)
{
  ClutterActorClass *actor_class = CLUTTER_ACTOR_CLASS (klass);
  StWidgetClass *widget_class = ST_WIDGET_CLASS (klass);

  actor_class->get_preferred_width = lemon_stack_get_preferred_width;
  actor_class->get_preferred_height = lemon_stack_get_preferred_height;
  actor_class->allocate = lemon_stack_allocate;

  widget_class->navigate_focus = lemon_stack_navigate_focus;
}

static void
lemon_stack_init (LemonStack *actor)
{
}
