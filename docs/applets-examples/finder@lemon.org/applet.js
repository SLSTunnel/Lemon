...
FileResultButton.prototype =
{
    ...
    _init: function(applet, result, type, custom_label)
    {
        ...
        try
        {
            let icon = Lemon.util_get_icon_for_uri(this._filename);
            if (icon)
            {
...
MyApplet.prototype =
{
    ...
    _init: function(orientation, panel_height, instanceId)
    {
        try
        {
            ...
            this.settings = new AppletSettings(this, "finder@lemon.org", instanceId);
            ...
            this._appSys = Lemon.AppSystem.get_default();
