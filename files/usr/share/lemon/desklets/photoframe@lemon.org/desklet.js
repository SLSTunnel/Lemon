...
class LemonPhotoFrameDesklet extends Desklet.Desklet {
    ...
    _setup_dir_monitor() {
        ...
        /* The widget used to choose the folder the images are drawn from
           ...
           to ensure that people upgrading lemon versions will get the
...
function main(metadata, desklet_id) {
    return new LemonPhotoFrameDesklet(metadata, desklet_id);
}
