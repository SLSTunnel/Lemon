...
const CUSTOM_LAUNCHERS_PATH = GLib.get_user_data_dir() + "/lemon/panel-launchers/";
const OLD_CUSTOM_LAUNCHERS_PATH = GLib.get_home_dir() + '/.lemon/panel-launchers/';

const ICON_SIZE = 48;
const ANIM_ICON_SIZE = 40;

class LemonLauncherDesklet extends Desklet.Desklet {
    constructor(metadata, desklet_id) {
        super(metadata, desklet_id);
        this._launcherSettings = new Gio.Settings({schema_id: 'org.lemon.desklets.launcher'});
        ...
        this._menu.addAction(
            ...
            Lang.bind(this, function() {
                Util.spawnCommandLine('/usr/share/lemon/desklets/launcher@lemon.org/editorDialog.py ' + this.instance_id);
            })
        );
    ...
    _getApp() {
        ...
        // No desktop file found; Default to 'lemon-settings.desktop'
        return appSys.lookup_app('lemon-settings.desktop');
    }
...
function main(metadata, desklet_id) {
    return new LemonLauncherDesklet(metadata, desklet_id);
}
