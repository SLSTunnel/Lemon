...
CSD_SCHEMA = "org.lemon.settings-daemon.plugins.power"
CSM_SCHEMA = "org.lemon.SessionManager"
...
class Module:
    ...
    def on_module_selected(self):
        ...
        self.csd_power_proxy = Gio.DBusProxy.new_sync(
            ...
            None,
            "org.lemon.SettingsDaemon.Power",
            "/org/lemon/SettingsDaemon/Power",
            "org.lemon.SettingsDaemon.Power",
            None)
        ...
        proxy = Gio.DBusProxy.new_sync(
            ...
            "org.lemon.SettingsDaemon.Power",
            "/org/lemon/SettingsDaemon/Power",
            "org.lemon.SettingsDaemon.Power.Screen",
            None)
        ...
        try:
            ...
            proxy = Gio.DBusProxy.new_sync(Gio.bus_get_sync(Gio.BusType.SESSION, None),
                                           ...
                                           "org.lemon.SettingsDaemon.Power",
                                           "/org/lemon/SettingsDaemon/Power",
                                           "org.lemon.SettingsDaemon.Power.Keyboard",
                                           None)
...
def get_available_options():
    ...
    try:
        proxy = Gio.DBusProxy.new_for_bus_sync(
                    ...
                    "/org/gnome/SessionManager",
                    "org.lemon.SessionManager.EndSessionDialog",
                    None)
