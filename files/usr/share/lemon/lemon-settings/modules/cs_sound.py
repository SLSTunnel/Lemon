...
LEMON_SOUNDS = "org.lemon.sounds"
LEMON_DESKTOP_SOUNDS = "org.lemon.desktop.sound"
OVERAMPLIFICATION_KEY = "allow-amplified-volume"

DECAY_STEP = .15

EFFECT_LIST = [
    {"label": _("Starting Lemon"),           "schema": LEMON_SOUNDS,         "file": "login-file",        "enabled": "login-enabled"},
    {"label": _("Leaving Lemon"),            "schema": LEMON_SOUNDS,         "file": "logout-file",       "enabled": "logout-enabled"},
    {"label": _("Switching workspace"),         "schema": LEMON_SOUNDS,         "file": "switch-file",       "enabled": "switch-enabled"},
    {"label": _("Opening new windows"),         "schema": LEMON_SOUNDS,         "file": "map-file",          "enabled": "map-enabled"},
    {"label": _("Closing windows"),             "schema": LEMON_SOUNDS,         "file": "close-file",        "enabled": "close-enabled"},
    {"label": _("Minimizing windows"),          "schema": LEMON_SOUNDS,         "file": "minimize-file",     "enabled": "minimize-enabled"},
    {"label": _("Maximizing windows"),          "schema": LEMON_SOUNDS,         "file": "maximize-file",     "enabled": "maximize-enabled"},
    {"label": _("Unmaximizing windows"),        "schema": LEMON_SOUNDS,         "file": "unmaximize-file",   "enabled": "unmaximize-enabled"},
    {"label": _("Tiling and snapping windows"), "schema": LEMON_SOUNDS,         "file": "tile-file",         "enabled": "tile-enabled"},
    {"label": _("Inserting a device"),          "schema": LEMON_SOUNDS,         "file": "plug-file",         "enabled": "plug-enabled"},
    {"label": _("Removing a device"),           "schema": LEMON_SOUNDS,         "file": "unplug-file",       "enabled": "unplug-enabled"},
    {"label": _("Showing notifications"),       "schema": LEMON_SOUNDS,         "file": "notification-file", "enabled": "notification-enabled"},
    {"label": _("Changing the sound volume"),   "schema": LEMON_DESKTOP_SOUNDS, "file": "volume-sound-file", "enabled": "volume-sound-enabled"}
]
...
class Module:
    ...
    def __init__(self, content_box):
        ...
        self.sound_settings = Gio.Settings(LEMON_DESKTOP_SOUNDS)
    ...
    def buildLayout(self):
        ...
        # overamplification
        switch = GSettingsSwitch(_("Overamplification"), LEMON_DESKTOP_SOUNDS, OVERAMPLIFICATION_KEY)
    ...
    def inializeController(self):
        self.controller = Cvc.MixerControl(name = "lemon")
    ...
    def streamAdded(self, c, deviceId):
        ...
        if stream in self.controller.get_sink_inputs():
            ...
            if name in ("lemon-settings.py",
                        "speech-dispatcher",
                        "speech-dispatcher-dummy",
                        "libcanberra",
                        "Muffin"):
                # lemon-settings.py: test sounds
                # speech-dispatcher[-dummy]: orca/speechd/spd-say
                # libcanberra: lemon effects, test sounds - don't think this is needed any more?
                # Muffin: window effects, some other lemon effects.
                return
