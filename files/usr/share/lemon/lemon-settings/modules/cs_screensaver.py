...
class Module:
    ...
    def on_module_selected(self):
        ...
        schema = "org.lemon.desktop.screensaver"
        ...
        widget = GSettingsComboBox(_("Delay before starting the screensaver"), "org.lemon.desktop.session", "idle-delay", LOCK_INACTIVE_OPTIONS, valtype=int, size_group=size_group)
        ...
        widget = GSettingsSwitch(_("Lock the computer when put to sleep"), "org.lemon.settings-daemon.plugins.power", "lock-on-suspend")
