...
class Module:
    comment = _("Manage your Lemon desklets")
    name = "desklets"
    category = "prefs"
...
class DeskletsViewSidePage(SidePage):
    ...
    def load(self, window):
        ...
        combo_box = GSettingsComboBox(_("Decoration of desklets"), "org.lemon", "desklet-decorations", dec, valtype=int)
        ...
        settings.add_row(GSettingsSwitch(_("Snap desklets to grid"), "org.lemon", "desklet-snap"))
        settings.add_reveal_row(GSettingsSpinButton(_("Width of desklet snap grid"), "org.lemon", "desklet-snap-interval", "", 0, 100, 1, 5), "org.lemon", "desklet-snap")

        settings = page.add_section("")
        settings.add_row(GSettingsSwitch(_("Lock desklets in their current position"), "org.lemon", "lock-desklets"))

class ManageDeskletsPage(ManageSpicesPage):
    directories = [f"{GLib.get_home_dir()}/.local/share/lemon/desklets", "/usr/share/lemon/desklets"]
    collection_type = "desklet"
