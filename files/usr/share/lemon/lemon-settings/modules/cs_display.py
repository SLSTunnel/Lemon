...
class Module:
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            switch = GSettingsSwitch(_("Disable automatic screen rotation"), "org.lemon.settings-daemon.peripherals.touchscreen", "orientation-lock")
            ...
            self.muffin_settings = Gio.Settings(schema_id="org.lemon.muffin")
            ...
            widget = GSettingsComboBox(_("Fractional scaling mode"), "org.lemon.muffin.x11", "fractional-scale-mode", scale_mode_options)
            settings.add_reveal_row(widget, "org.lemon.muffin", "experimental-features", [], lambda val, vals: "x11-randr-fractional-scaling" in val)
