...
class Module:
    ...
    def on_module_selected(self):
        if not self.loaded:
            ...
            self.iface_settings = Gio.Settings(schema_id="org.lemon.desktop.interface")
            self.wm_settings = Gio.Settings(schema_id="org.lemon.desktop.wm.preferences")
            self.mag_settings = Gio.Settings(schema_id="org.lemon.desktop.a11y.magnifier")
...
# Visual Aids
            ...
            switch = GSettingsDependencySwitch(_("Screen reader"),
                                               "org.lemon.desktop.a11y.applications",
            ...
            settings.add_reveal_row(button, "org.lemon.desktop.a11y.applications", "screen-reader-enabled")

# Desktop Zoom

            settings = page.add_section(_("Desktop Zoom"))

            switch = GSettingsSwitch(_("Enable zoom"), "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")
            settings.add_row(switch)

            spin = GSettingsSpinButton(_("Magnification"), "org.lemon.desktop.a11y.magnifier", "mag-factor", None, 1.0, 15.0, step=0.5)
            settings.add_reveal_row(spin, "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")

            zoom_key_options = [["", _("Disabled")], ["<Alt>", "<Alt>"],["<Super>", "<Super>"],["<Control>", "<Control>"], ["<Shift>", "<Shift>"]]
            widget = GSettingsComboBox(_("Mouse wheel modifier"), "org.lemon.desktop.wm.preferences", "mouse-button-zoom-modifier", zoom_key_options)
            widget.set_tooltip_text(_("While this modifier is pressed, mouse scrolling will increase or decrease zoom."))
            settings.add_reveal_row(widget, "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")

            switch = GSettingsSwitch(_("Scroll at screen edges"), "org.lemon.desktop.a11y.magnifier", "scroll-at-edges")
            settings.add_reveal_row(switch, "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")
            ...
            widget = GSettingsComboBox(_("Mouse tracking mode"), "org.lemon.desktop.a11y.magnifier", "mouse-tracking", mouse_track_options)
            settings.add_reveal_row(widget, "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")

            switch = GSettingsSwitch(_("Lens mode"), "org.lemon.desktop.a11y.magnifier", "lens-mode")
            settings.add_reveal_row(switch, "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")
            ...
            widget = GSettingsComboBox(_("Lens shape"), "org.lemon.desktop.a11y.magnifier", "lens-shape", lens_shape_options)
            ...
            widget = GSettingsComboBox(_("Screen position"), "org.lemon.desktop.a11y.magnifier", "screen-position", screen_pos_options)
            self.zoom_stack.add_named(widget, "screen")

            settings.add_reveal_row(self.zoom_stack, "org.lemon.desktop.a11y.applications", "screen-magnifier-enabled")
...
# Virtual keyboard
            ...
            widget = GSettingsComboBox(_("Keyboard position"), "org.lemon.keyboard", "keyboard-position", keyboard_position_options)
            settings.add_reveal_row(widget, "org.lemon.desktop.a11y.applications", "screen-keyboard-enabled")

            keyboard_size_options = [[4,     _("A quarter of the screen")],
                                     [3,     _("A third of the screen")]]

            widget = GSettingsComboBox(_("Keyboard size"), "org.lemon.keyboard", "keyboard-size", keyboard_size_options)
            settings.add_reveal_row(widget, "org.lemon.desktop.a11y.applications", "screen-keyboard-enabled")
            ...
            widget = GSettingsComboBox(_("Activation mode"), "org.lemon.keyboard", "activation-mode", activation_mode_options)
            settings.add_reveal_row(widget, "org.lemon.desktop.a11y.applications", "screen-keyboard-enabled")
...
# Keyboard indicators
            ...
            switch = GSettingsSwitch(_("Use visual indicator on Caps and Num Lock"),
                                     "org.lemon.desktop.a11y.keyboard",
            ...
            sound_picker = GSettingsSoundFileChooser(_("Sound to use Caps or Num Lock on"),
                                                     "org.lemon.desktop.a11y.keyboard",
                                                     "togglekeys-sound-on")
            settings.add_reveal_row(sound_picker, "org.lemon.desktop.a11y.keyboard", "togglekeys-enable-beep")
            ...
            switch = GSettingsSwitch(_("Enable visual alerts"),
                                     "org.lemon.desktop.wm.preferences",
                                     "visual-bell")
            settings.add_row(switch)
            ...
            widget = GSettingsComboBox(_("Visual style"), "org.lemon.desktop.wm.preferences", "visual-bell-type", visual_bell_options)
            settings.add_reveal_row(widget, "org.lemon.desktop.wm.preferences", "visual-bell")
            ...
            sound_picker = GSettingsSoundFileChooser(_("Sound to use for window alerts"),
                                                     "org.lemon.desktop.wm.preferences",
                                                     "bell-sound")
            settings.add_reveal_row(sound_picker, "org.lemon.desktop.wm.preferences", "audible-bell")
...
# Stickykeys
            ...
            settings.add_reveal_row(switch, "org.lemon.desktop.a11y.keyboard", "stickykeys-enable")

            switch = GSettingsSwitch(_("Alert when a modifier key is pressed"),
                                     "org.lemon.desktop.a11y.keyboard",
                                     "stickykeys-modifier-beep",
                                     "org.lemon.desktop.sound/event-sounds")
...
# Slowkeys
            ...
            settings.add_reveal_row(switch, "org.lemon.desktop.a11y.keyboard", "slowkeys-enable")
            ...
            settings.add_reveal_row(slider, "org.lemon.desktop.a11y.keyboard", "slowkeys-enable")
...
# Bouncekeys
            ...
            settings.add_reveal_row(switch, "org.lemon.desktop.a11y.keyboard", "bouncekeys-enable")
            ...
            settings.add_reveal_row(slider, "org.lemon.desktop.a11y.keyboard", "bouncekeys-enable")
...
# Mousekeys
            ...
            settings.add_reveal_row(slider, "org.lemon.desktop.a11y.keyboard", "mousekeys-enable")
...
# Secondary click
            ...
            settings.add_reveal_row(slider, "org.lemon.desktop.a11y.mouse", "secondary-click-enabled")
...
# Hover Click
            ...
            settings.add_reveal_row(slider, "org.lemon.desktop.a11y.mouse", "dwell-click-enabled")
