...
MEDIA_HANDLING_SCHEMA = "org.lemon.desktop.media-handling"
TERMINAL_SCHEMA = "org.lemon.desktop.default-applications.terminal"
CALCULATOR_SCHEMA = "org.lemon.desktop.default-applications.calculator"
...
class DefaultTerminalButton(Gtk.AppChooserButton):
    #TODO: See if we can get this to change the x-terminal-emulator default to allow it to be a more global change rather then just lemon/nemo
    def __init__(self):
