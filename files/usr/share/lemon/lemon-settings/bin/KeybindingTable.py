...
gettext.install("lemon", "/usr/share/locale")
...
CUSTOM_KEYS_PARENT_SCHEMA = "org.lemon.desktop.keybindings"
CUSTOM_KEYS_BASENAME = "/org/lemon/desktop/keybindings/custom-keybindings"
CUSTOM_KEYS_SCHEMA = "org.lemon.desktop.keybindings.custom-keybinding"

MUFFIN_KEYBINDINGS_SCHEMA = "org.lemon.desktop.keybindings.wm"
MEDIA_KEYS_SCHEMA = "org.lemon.desktop.keybindings.media-keys"
LEMON_SCHEMA = "org.lemon.desktop.keybindings"
ENABLED_SCHEMA = "org.lemon"

OLD_SETTINGS_DIR = Path.joinpath(Path.home(), ".lemon/configs/")
SETTINGS_DIR = Path.joinpath(Path.home(), ".config/lemon/spices/")
...
[
  [_("General"), "general", None, "xsi-keyboard-shortcuts-symbolic",
    [
      [_("Pointer"), "pointer", "general", None, [],
        [
          [_("Move pointer to the next monitor"), LEMON_SCHEMA, "pointer-next-monitor"],
          [_("Move pointer to the previous monitor"), LEMON_SCHEMA, "pointer-previous-monitor"]
        ]
      ],
      [_("Troubleshooting"), "trouble", "general", None, [],
        [
          [_("Toggle Looking Glass"), LEMON_SCHEMA, "looking-glass-keybinding"]
        ]
      ]
    ],
    [
      ...
      [_("Show Desklets"), LEMON_SCHEMA, "show-desklets"],
    ...
    [
      ...
      [_("Screenshots and Recording"), "sys-screen", "system", None, [],
        [
          ...
          [_("Toggle recording desktop (must restart Lemon)"), MUFFIN_KEYBINDINGS_SCHEMA, "toggle-recording"]
        ]
      ]
    ],
    [
      ...
      [_("Restart Lemon"), MEDIA_KEYS_SCHEMA, "restart-lemon"]
    ]
  ],
  ...
  [_("Universal Access"), "accessibility", None, "xsi-accessibility-symbolic", [],
    [
      [_("Zoom in"), LEMON_SCHEMA, "magnifier-zoom-in"],
      [_("Zoom out"), LEMON_SCHEMA, "magnifier-zoom-out"],
      [_("Reset zoom"), LEMON_SCHEMA, "magnifier-zoom-reset"],
  ...
  [_("Spices"), "spices", None, "lemon-symbolic", [], []]
]
...
class CustomKeyBinding(GObject.Object):
    ...
    def writeSettings(self, emit_changed=False):
        ...
        # Touch the custom-list key, this will trigger a rebuild in lemon
...
class KeybindingTable(GObject.Object):
    ...
    def _on_proxy_ready(self, obj, result, data=None):
        try:
            ...
            print(f"KeybindingTable could not establish proxy for org.Lemon: {e}")
    ...
    def _load_spice_store(self):
        ...
        for spice, bindings in spice_keybinds.items():
            ...
            local_metadata_path = Path.home() / '.local/share/lemon' / _type / uuid / 'metadata.json'
            if local_metadata_path.exists():
                ...
                system_metadata_path = Path("/usr/share/lemon") / _type / uuid / "metadata.json"
