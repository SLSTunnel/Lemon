...
class GtkCssEditor:
    def __init__(self, selector):
        ...
        self.rule_separator = f"/***** {self.selector} - lemon-settings-generated - do not edit *****/"
        rules = []
...
class PreviewWidget(SettingsWidget):
    def __init__(self):
        ...
        self.builder.set_translation_domain('lemon')
        self.builder.add_from_file("/usr/share/lemon/lemon-settings/bin/scrollbar-test-widget.glade")
...
class Gtk2ScrollbarSizeEditor:
    def __init__(self, ui_scale):
        ...
        self._settings = Gio.Settings(schema_id="org.lemon.theme")
    ...
    def make_default_contents(self):
        self._contents = """
###############################################
# Created by lemon-settings - please do not edit or reformat.
#
