...
from gi.repository import GLib, Gio, Gtk, GObject, LemonDesktop, IBus, Pango
...
INPUT_SOURCE_SETTINGS = "org.lemon.desktop.input-sources"
...
class AddKeyboardLayoutDialog():
    ...
    def _reload_all_engines(self):
        ...
        if self.input_source_settings.get_boolean(SHOW_ALL_SOURCES_KEY):
            ...
            self.xkb_info = LemonDesktop.XkbInfo.new()
