...
class LemonPanelLaunchersApplet extends Applet.Applet {
    ...
    showAddLauncherDialog(timestamp, launcher){
        if (launcher) {
            Util.spawnCommandLine("lemon-desktop-editor -mlemon-launcher --icon-size %d -f %s %s"
                .format(this.icon_size, launcher.getId(), this.settings.file.get_path()));
        } else {
            Util.spawnCommandLine("lemon-desktop-editor -mlemon-launcher --icon-size %d %s"
...
Signals.addSignalMethods(LemonPanelLaunchersApplet.prototype);

function main(metadata, orientation, panel_height, instance_id) {
    return new LemonPanelLaunchersApplet(metadata, orientation, panel_height, instance_id);
}
