...
class LemonSettingsExampleApplet extends Applet.TextIconApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "settings-example@lemon.org", instance_id);
...
function main(metadata, orientation, panel_height, instance_id) {  // Make sure you collect and pass on instanceId
    return new LemonSettingsExampleApplet(orientation, panel_height, instance_id);
}
