...
const DAY_FORMAT = LemonDesktop.WallClock.lctime_format("lemon", "%A");
const DATE_FORMAT_SHORT = LemonDesktop.WallClock.lctime_format("lemon", _("%B %-e, %Y"));
const DATE_FORMAT_FULL = LemonDesktop.WallClock.lctime_format("lemon", _("%A, %B %-e, %Y"));

class LemonCalendarApplet extends Applet.TextApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        try {
            ...
            this.settings = new Settings.AppletSettings(this, "calendar@lemon.org", this.instance_id);
            this.desktop_settings = new Gio.Settings({ schema_id: "org.lemon.desktop.interface" });

            this.clock = new LemonDesktop.WallClock();
    ...
    on_custom_format_button_pressed() {
        Util.spawnCommandLine("xdg-open https://lemon-spices.linuxmint.com/strftime.php");
    }

    _onLaunchSettings() {
        this.menu.close();
        Util.spawnCommandLine("lemon-settings calendar");
    }
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonCalendarApplet(orientation, panel_height, instance_id);
}
