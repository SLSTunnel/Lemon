...
class LemonTrashApplet extends Applet.IconApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        if (vfs.get_supported_uri_schemes().includes("trash")) {
            ...
            global.logWarning("trash@lemon.org: No trash support, disabling.")
            this.actor.hide();
        }
    }
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonTrashApplet(orientation, panel_height, instance_id);
}
