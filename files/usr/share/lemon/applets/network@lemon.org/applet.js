...
NMDeviceModem.prototype = {
    ...
    _createAutomaticConnection: function() {
        // Mobile wizard is too complex for Lemon UI and
        // is handled by the network panel
        Util.spawn(['lemon-settings', 'network',
    ...
    _init: function(client, device, connections) {
        ...
        for (let i = 0; i < accessPoints.length; i++) {
            ...
            if (ap.get_ssid() == null) {
                ...
                // NetworkManager connects to it (via nmcli or lemon-settings)
        ...
        if(apObj.connections.length > 0) {
            ...
            apObj.item.connect('activate', Lang.bind(this, function() {
                ...
                if ((accessPoints[0]._secType == NMAccessPointSecurity.WPA2_ENT) ||
                    ...
                    // handled in lemon-settings
                    Util.spawn(['lemon-settings', 'network', 'connect-8021x-wifi',
...
function LemonNetworkApplet(metadata, orientation, panel_height, instance_id) {
    this._init(metadata, orientation, panel_height, instance_id);
}

LemonNetworkApplet.prototype = {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonNetworkApplet(metadata, orientation, panel_height, instance_id);
}
