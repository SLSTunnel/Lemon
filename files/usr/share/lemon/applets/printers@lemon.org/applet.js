...
const APPLET_PATH = imports.ui.appletManager.appletMeta['printers@lemon.org'].path;


class LemonPrintersApplet extends Applet.TextIconApplet {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonPrintersApplet(metadata, orientation, panel_height, instance_id);
}
