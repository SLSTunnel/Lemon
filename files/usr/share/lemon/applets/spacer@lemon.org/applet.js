...
class LemonSpacerApplet extends Applet.Applet {
    constructor(metadata, orientation, panelHeight, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "spacer@lemon.org", this.instance_id);
...
function main(metadata, orientation, panelHeight, instance_id) {
    return new LemonSpacerApplet(metadata, orientation, panelHeight, instance_id);
}
