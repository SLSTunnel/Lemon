...
const LEMON_DESKTOP_SOUNDS = "org.lemon.desktop.sound";
...
class LemonSoundApplet extends Applet.TextIconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        ...
        this._sound_settings = new Gio.Settings({ schema_id: LEMON_DESKTOP_SOUNDS });
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LemonSoundApplet(metadata, orientation, panel_height, instanceId);
}
