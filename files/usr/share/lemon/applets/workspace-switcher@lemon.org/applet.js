...
class WorkspaceGraph extends WorkspaceButton {
    constructor(index, applet) {
        ...
        this.windowTracker = Lemon.WindowTracker.get_default();
...
class LemonWorkspaceSwitcher extends Applet.Applet {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonWorkspaceSwitcher(metadata, orientation, panel_height, instance_id);
}
