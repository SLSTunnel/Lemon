...
const A11Y_KEYBOARD_SCHEMA = 'org.lemon.desktop.a11y.keyboard';
const A11Y_MOUSE_SCHEMA = 'org.lemon.desktop.a11y.mouse';
...
const APPLICATIONS_SCHEMA = 'org.lemon.desktop.a11y.applications';

const DPI_FACTOR_LARGE   = 1.25;

const DESKTOP_INTERFACE_SCHEMA = 'org.lemon.desktop.interface';
const KEY_GTK_THEME      = 'gtk-theme';
const KEY_ICON_THEME     = 'icon-theme';
const KEY_TEXT_SCALING_FACTOR = 'text-scaling-factor';

const WM_PREFERENCES_SCHEMA  = 'org.lemon.desktop.wm.preferences';
...
class LemonA11YApplet extends Applet.TextIconApplet {
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonA11YApplet(metadata, orientation, panel_height, instance_id);
}
