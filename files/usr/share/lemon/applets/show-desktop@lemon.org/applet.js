...
class LemonShowDesktopApplet extends Applet.IconApplet {
    constructor(orientation, panel_height, instance_id) {
        super(orientation, panel_height, instance_id);

        this.settings = new AppletSettings(this, "show-desktop@lemon.org", instance_id);
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonShowDesktopApplet(orientation, panel_height, instance_id);
}
