...
class InhibitSwitch extends PopupMenu.PopupBaseMenuItem {
    ...
    toggled(active) {
        if (!active && !this.sessionCookie) {
            this.sessionProxy.InhibitRemote("inhibit@lemon.org",
                0,
...
class LemonInhibitApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        ...
        this.notif_settings = new Gio.Settings({ schema_id: "org.lemon.desktop.notifications" });
    ...
    on_btn_open_system_power_settings_clicked() {
        Util.spawnCommandLine("lemon-settings power");
    }

    on_btn_open_system_notification_settings_clicked() {
        Util.spawnCommandLine("lemon-settings notifications");
    }
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LemonInhibitApplet(metadata, orientation, panel_height, instanceId);
}
