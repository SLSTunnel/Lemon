...
class LemonXrandrApplet extends Applet.IconApplet {
    ...
    _generate_menu() {
        ...
        this.menu.addAction(_("Configure display settings..."), function() {
            GLib.spawn_command_line_async('lemon-settings display');
        });
    }
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonXrandrApplet(orientation, panel_height, instance_id);
}
