 ...
 * LemonGenericContainer.  We manage the allocation ourselves and shrink the
...
class AppMenuButton {
    constructor(applet, metaWindow, transient) {
        ...
        this._iconBox = new Lemon.Slicer({ name: 'appMenuIcon' });
    ...
    _getApp() {
        const tracker = Lemon.WindowTracker.get_default();
...
class LemonWindowListApplet extends Applet.Applet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "window-list@lemon.org", this.instance_id);
        ...
        this.signals.connect(Lemon.WindowTracker.get_default(), "window-app-changed", this._onWindowAppChanged, this);
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonWindowListApplet(orientation, panel_height, instance_id);
}
