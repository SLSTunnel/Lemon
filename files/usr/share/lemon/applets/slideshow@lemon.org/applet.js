...
class LemonSlideshowApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        super(orientation, panel_height, instanceId);

        this._slideshowSettings = new Gio.Settings({ schema_id: "org.lemon.desktop.background.slideshow" });
        this._backgroundSettings = new Gio.Settings({ schema_id: "org.lemon.desktop.background" });
        ...
        this.open_settings_context_menu_item.connect('activate', Lang.bind(this, function() {
            Util.spawnCommandLine("lemon-settings backgrounds");
        }));
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LemonSlideshowApplet(metadata, orientation, panel_height, instanceId);
}
