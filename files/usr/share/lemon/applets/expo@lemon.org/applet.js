...
class LemonExpoApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instance_id) {
        super(orientation, panel_height, instance_id);

        try {
            this.set_applet_icon_symbolic_name("lemon-expo");
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonExpoApplet(metadata, orientation, panel_height, instance_id);
}
