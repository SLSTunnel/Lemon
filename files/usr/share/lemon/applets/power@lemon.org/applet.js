...
const BrightnessBusName = "org.lemon.SettingsDaemon.Power.Screen";
const KeyboardBusName = "org.lemon.SettingsDaemon.Power.Keyboard";
...
class LemonPowerApplet extends Applet.TextIconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        ...
        this.csd_power_watch_id = Gio.bus_watch_name(Gio.BusType.SESSION, "org.lemon.SettingsDaemon.Power", 0, (c, name) => {
            Interfaces.getDBusProxyAsync("org.lemon.SettingsDaemon.Power", Lang.bind(this, function (proxy, error) {
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LemonPowerApplet(metadata, orientation, panel_height, instanceId);
}
