...
const Gettext = imports.gettext.domain("lemon-applets");
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LemonNotificationsApplet(metadata, orientation, panel_height, instanceId);
}
...
function timeify(orig_time) {
    let settings = new Gio.Settings({schema_id: 'org.lemon.desktop.interface'});
