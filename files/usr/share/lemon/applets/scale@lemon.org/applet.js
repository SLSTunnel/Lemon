...
class LemonScaleApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instance_id) {
        super(orientation, panel_height, instance_id);

        try {
            this.set_applet_icon_symbolic_name("lemon-scale");
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonScaleApplet(metadata, orientation, panel_height, instance_id);
}
