...
class LemonOnScreenKeyboardApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panel_height, instanceId) {
        super(orientation, panel_height, instanceId);
        this.settings = new Gio.Settings({ schema_id: 'org.lemon.desktop.a11y.applications' });
...
function main(metadata, orientation, panel_height, instanceId) {
    return new LemonOnScreenKeyboardApplet(metadata, orientation, panel_height, instanceId);
}
