...
const USER_DEFAULT_IMG_PATH = "/usr/share/lemon/faces/user-generic.png";

class LemonUserApplet extends Applet.TextApplet {
    constructor(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "user@lemon.org", instance_id);
        ...
        item.connect('activate', Lang.bind(this, function() {
            Util.spawnCommandLine("lemon-settings");
        }));
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonUserApplet(orientation, panel_height, instance_id);
}
