...
class LemonBarApplet extends Applet.Applet {
    constructor(orientation, panel_height, instance_id) {
        super(orientation, panel_height, instance_id);
        this.muffinSettings = new Gio.Settings({ schema_id: 'org.lemon.muffin' });
        this.settings = new Settings.AppletSettings(this, "cornerbar@lemon.org", instance_id);
...
function main(metadata, orientation, panel_height, instance_id) {
    return new LemonBarApplet(orientation, panel_height, instance_id);
}
