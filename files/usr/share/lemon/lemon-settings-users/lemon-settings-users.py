...
class Module:
    def __init__(self):
        try:
            ...
            self.builder.add_from_file("/usr/share/lemon/lemon-settings-users/lemon-settings-users.ui")
            ...
            self.face_image.set_from_file("/usr/share/lemon/faces/user-generic.png")
            ...
            col = 0
            num_cols = 4
            face_dirs = ["/usr/share/lemon/faces"]
    ...
    def load_users(self):
        ...
        for user in users:
            if os.path.exists(user.get_icon_file()):
                ...
                pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_size("/usr/share/lemon/faces/user-generic.png", 48, 48)
...
if __name__ == "__main__":
    setproctitle("lemon-settings-users")
    module = Module()
    Gtk.main()
