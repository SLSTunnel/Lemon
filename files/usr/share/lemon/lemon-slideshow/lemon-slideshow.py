...
SLIDESHOW_DBUS_NAME = "org.Lemon.Slideshow"
SLIDESHOW_DBUS_PATH = "/org/Lemon/Slideshow"
...
DBUS_INTERFACE_XML = '''
<node>
    <interface name="org.Lemon.Slideshow">
        <method name="begin" />
        <method name="end" />
...
class LemonSlideshowApplication(Gio.Application):
    def __init__(self):
        super().__init__(
        ...
        self.slideshow_settings = Gio.Settings(schema="org.lemon.desktop.background.slideshow")
        self.background_settings = Gio.Settings(schema="org.lemon.desktop.background")
...
if __name__ == "__main__":
    setproctitle("lemon-slideshow")

    app = LemonSlideshowApplication()
    app.run()